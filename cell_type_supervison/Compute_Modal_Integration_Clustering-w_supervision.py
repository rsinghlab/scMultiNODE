...
from modal_integration.Compare_Modal_Alignment_Clustering import computeClusteringScore, plotMetric
...
if __name__ == '__main__':
    ...
    latent_dim = 50
    # -----
    save_filename = "./res/{}-{}-{}-ae-{}dim-clustering.npy".format(data_name, data_type, split_type, latent_dim)
